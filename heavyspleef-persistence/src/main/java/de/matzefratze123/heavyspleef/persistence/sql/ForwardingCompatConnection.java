...
public class ForwardingCompatConnection implements Connection {
	...
	public static ForwardingCompatConnection wrap(Connection delegate, SQLImplementation implementation) {
		return new ForwardingCompatConnection(delegate, implementation);
	}
	
	private ForwardingCompatConnection(Connection delegate, SQLImplementation implementation) {
	...
	private int getResultSetHoldability() {
		...
		if (implementation == SQLImplementation.SQLITE) {
