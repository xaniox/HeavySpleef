...
public class HeavySpleefDatabaseUpgrader implements DatabaseUpgrader {
	...
	@Override
	public void upgrade(Connection connection, int oldVersion, int newVersion) {
		//Nothing in here yet, content will follow as soon as there are more releases of HeavySpleef > 2.0 available
	}
