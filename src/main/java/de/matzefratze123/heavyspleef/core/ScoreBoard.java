...
public class ScoreBoard extends RegionCuboid implements DatabaseSerializeable {
	 ...
	 * 
	 * @param firstPointLocation
	 *            The upper-left firstPoint of this scoreboard
	 * @param direction
	 *            The orentation blockface of this scoreboard
	 */
	 ...
	 * 
	 * @param characters
	 *            An array with the length of 4; filled with characters 0 - 9
	 */
	 ...
	 *            Base location
	 * @param directions
	 *            Directions; even indexes has to be a blockface, uneven indexes
	 *            a Integer
