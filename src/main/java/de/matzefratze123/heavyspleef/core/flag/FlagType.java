...
public enum FlagType {
	...
	INTEGER_FLAG, LOCATION_FLAG, BOOLEAN_FLAG, ARRAY_ITEMSTACK_FLAG, ENUM_FLAG, SINGLE_ITEMSTACK_FLAG, LISTFLAG;
	 ...
	 */
	public static final String								FRIENDLY_FLAG_LIST	= "1vs1, shovels, shears, team, bowspleef, splegg, boxes, anticamping, blockbreakeffect, " + "win, lose, lobby, queuelobby, spectate, spawnpoint, nextspawnpoint, itemreward, "
																						+ "minplayers, maxplayers, autostart, countdown, entryfee, reward, timeout, rounds, regen, " + "icon, leavepoint, leatherarmor, scoreboard";
	...
	/**
	 * Registeres a flag for spleef arenas Your flag has to extend the Flag
	 * classes
	 * 
	 * @see IntegerFlag
	 * @see BooleanFlag
