...
public class PvPTimerManager implements Listener {
	...
	/**
	 * Adds a player to the timer and runs the Runnable when the player didn't
	 * move, didn't quit and didn't die.
	 * 
	 * @param player
	 *            The player to add
	 * @param target
	 *            The runnable to run when the task hasn't been destroyed for
	 *            the player
	 * @param ticksUntilEnd
	 *            The amount of ticks until the target will be executed and the
	 *            player will be removed from the timer
	 */
	...
	/**
	 * Adds a player to the timer and runs the Runnable when the player didn't
	 * move, didn't quit and didn't die. </br></br> This method uses the default
	 * tick amount from the config until the target is going to be executed
	 * 
	 * @param player
	 *            The player to add
	 * @param target
	 ...
	 * @param announce
	 *            If we should send the player a fail message
	 */
	...
	/**
	 * Cancels the task for a player. This calls
	 * {@link #cancel(SpleefPlayer, boolean)} with the announce value of true
	 * 
	 * @param player
	 */
