...
public class StatisticModule implements Comparable<StatisticModule> {
	...
	private void updateScore() {
		...
		int score = (pointsWin * getScore(StatisticValue.WIN)) + (pointsLose * getScore(StatisticValue.LOSE)) + (pointsKnockout * getScore(StatisticValue.KNOCKOUTS)) + (pointsGamePlayed * getScore(StatisticValue.GAMES_PLAYED));
	...
	public enum StatisticValue {
		...
		WIN("wins"), LOSE("loses"), KNOCKOUTS("knockouts"), GAMES_PLAYED("games"), SCORE("score");
