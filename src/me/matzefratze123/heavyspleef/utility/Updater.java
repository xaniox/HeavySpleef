 ...
 * 
 * All credits for this awesome class are going to Gravity from the bukkit forums | Link: http://forums.bukkit.org/threads/updater-easy-safe-and-policy-compliant-auto-updating-for-your-plugins.96681/
 */
...
public class Updater
{
    ...
    public  String updateFolder = YamlConfiguration.loadConfiguration(new File("bukkit.yml")).getString("settings.update-folder"); // The folder that downloads will be placed in
